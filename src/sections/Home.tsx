      ...
      <div className="flex flex-col items-center text-center w-full">
        ...
        <div className="flex flex-row gap-8 mt-10">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="text-[#0ff4c6] text-glow-subtle">Resume</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Link href="https://github.com/Farbubby">
              <svg
            ...
            <div className="text-[#0ff4c6] text-glow-subtle">GitHub</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Link
            ...
            <div className="text-[#0ff4c6] text-glow-subtle">LinkedIn</div>
          </div>
        </div>
      </div>
    </>
